/* グッズ（アフィリエイト商品）データ
   ...
   category  : ぬいぐるみ / フィギュア / 食器 / 雑貨 / 文具 / アクセサリー / 書籍 / ゲーム / 音楽
...
window.DB_GOODS = [
  ...
  /* ============================== ぬいぐるみ ============================== */
  {
    id: "G001", name: "スマイルスライム ぬいぐるみ スライム M", category: "ぬいぐるみ", emoji: "🧸",
  ...
  {
    id: "G013", name: "スマイルスライム ぬいぐるみ M だるまスライム 青", category: "ぬいぐるみ", emoji: "🔵",
  ...
  {
    id: "G014", name: "スマイルスライム ぬいぐるみ M だるまスライム 赤", category: "ぬいぐるみ", emoji: "🔴",
  ...
  {
    id: "G015", name: "スマイルスライム ぬいぐるみ M わたぼう", category: "ぬいぐるみ", emoji: "☁️",
  ...
  {
    id: "G016", name: "スマイルスライム ぬいぐるみ スライムタワー M", category: "ぬいぐるみ", emoji: "🗼",
  ...
  {
    id: "G017", name: "スマイルスライム ぬいぐるみクリーナー スライム", category: "ぬいぐるみ", emoji: "🧽",
  ...
  {
    id: "G008", name: "手のひらマスコット キラーマシン", category: "ぬいぐるみ", emoji: "🐾",
  ...
  {
    id: "G018", name: "スマイルスライム マスコット スライム", category: "ぬいぐるみ", emoji: "🫧",
  ...
  /* ============================== フィギュア ============================== */
  {
    id: "G002", name: "メタリックモンスターズギャラリー メタルスライム", category: "フィギュア", emoji: "⚪",
  ...
  {
    id: "G003", name: "メタリックモンスターズギャラリー ダースドラゴン", category: "フィギュア", emoji: "🐉",
  ...
  {
    id: "G019", name: "メタリックモンスターズギャラリー キラーマシン", category: "フィギュア", emoji: "🤖",
  ...
  {
    id: "G020", name: "メタリックモンスターズギャラリー ハートナイト", category: "フィギュア", emoji: "🛡️",
  ...
  {
    id: "G024", name: "ドラゴンクエスト AM 伝説の魔王フィギュア 竜王", category: "フィギュア", emoji: "👑",
  ...
  {
    id: "G025", name: "AM フィギュアコレクション 仲間モンスター編 5種セット", category: "フィギュア", emoji: "🎎",
  ...
  {
    id: "G012", name: "立体モンスター図鑑フィギュア 大集合スペシャル（9個入りBOX）", category: "フィギュア", emoji: "🎁",
  ...
  {
    id: "G021", name: "メタリックアイテムズギャラリー 宝箱", category: "フィギュア", emoji: "🧰",
  ...
  {
    id: "G022", name: "メタリックアイテムズギャラリー スペシャル ロトの鎧＆ロトの兜", category: "フィギュア", emoji: "⚔️",
  ...
  {
    id: "G023", name: "メタリックアイテムズギャラリー スペシャル 天空の鎧＆天空の兜", category: "フィギュア", emoji: "🗡️",
  ...
  /* ============================== 食器 ============================== */
  {
    id: "G005", name: "スマイルスライム マグカップ スライム", category: "食器", emoji: "☕",
  ...
  {
    id: "G033", name: "スマイルスライム マグカップ キングスライム", category: "食器", emoji: "👑",
  ...
  {
    id: "G034", name: "スマイルスライム マグカップ スライムナイト", category: "食器", emoji: "🐴",
  ...
  {
    id: "G028", name: "ドラゴンクエスト 和シリーズ お箸＆箸置きセット ブルー", category: "食器", emoji: "🥢",
  ...
  {
    id: "G029", name: "スマイルスライム ソルト＆ペッパー", category: "食器", emoji: "🧂",
  ...
  {
    id: "G035", name: "スマイルスライム アイスクリームスプーン メタルスライム", category: "食器", emoji: "🍨",
  ...
  /* ============================== 雑貨 ============================== */
  {
    id: "G011", name: "スマイルスライム たためる収納箱 ひとくいばこ", category: "雑貨", emoji: "📦",
  ...
  {
    id: "G027", name: "スマイルスライム 陶器貯金箱 スライム", category: "雑貨", emoji: "🏦",
  ...
  {
    id: "G030", name: "ドラゴンクエスト スライム砂時計 メタルスライム", category: "雑貨", emoji: "⏳",
  ...
  {
    id: "G031", name: "ドラゴンクエスト トラベル アイマスク はぐれメタル", category: "雑貨", emoji: "😴",
  ...
  {
    id: "G032", name: "スマイルスライム 和シリーズ てぬぐい そら", category: "雑貨", emoji: "🧻",
  ...
  /* ============================== 文具 ============================== */
  {
    id: "G036", name: "DQ文具屋 デコレーションシール スライムデザイン", category: "文具", emoji: "🩹",
  ...
  {
    id: "G037", name: "ドラゴンクエスト 浸透印スタンプ ハーフ スライム", category: "文具", emoji: "🖃",
  ...
  /* ============================== アクセサリー ============================== */
  {
    id: "G006", name: "キーホルダー ロトの鎧＆ロトの剣", category: "アクセサリー", emoji: "🗡️",
  ...
  {
    id: "G041", name: "キーホルダー ロトの兜＆ロトの盾", category: "アクセサリー", emoji: "🛡️",
  ...
  {
    id: "G040", name: "ドラゴンクエスト キーホルダー ロトのしるし", category: "アクセサリー", emoji: "🔰",
  ...
  {
    id: "G038", name: "ドラゴンクエスト フィギュアキーホルダー キングスライム", category: "アクセサリー", emoji: "👑",
  ...
  {
    id: "G039", name: "ドラゴンクエスト フィギュアキーホルダー スライム", category: "アクセサリー", emoji: "🔵",
  ...
  {
    id: "G042", name: "スマイルスライム メタルキーリング スライム", category: "アクセサリー", emoji: "🔗",
  ...
  {
    id: "G043", name: "スマイルスライム ラメでキラキラ！キーホルダー マリンスライム", category: "アクセサリー", emoji: "✨",
  ...
  {
    id: "G044", name: "ドラゴンクエスト アクリルキーホルダー 40周年記念Ver.", category: "アクセサリー", emoji: "🪧",
  ...
  {
    id: "G026", name: "ドラゴンクエスト 40周年記念ピンズ", category: "アクセサリー", emoji: "📌",
  ...
  {
    id: "G010", name: "ドラゴンクエストモンスターズ3 アクリルスタンド", category: "アクセサリー", emoji: "🖼️",
  ...
  /* ============================== 書籍 ============================== */
  {
    id: "G004", name: "ドラゴンクエスト25thアニバーサリー モンスター大図鑑", category: "書籍", emoji: "📖",
  ...
  {
    id: "G045", name: "ドラゴンクエスト25thアニバーサリー 冒険の歴史書", category: "書籍", emoji: "📚",
  ...
  {
    id: "G046", name: "ドラゴンクエストI＆II 公式ガイドブック【HD-2D版】", category: "書籍", emoji: "🗺️",
  ...
  {
    id: "G047", name: "ドラゴンクエスト1＆2 LEGENDARY GUIDEBOOK", category: "書籍", emoji: "📕",
  ...
  /* ============================== ゲーム ============================== */
  {
    id: "G007", name: "ドラゴンクエストモンスターズ3 魔族の王子とエルフの旅（Switch）", category: "ゲーム", emoji: "🎮",
  ...
  {
    id: "G048", name: "ドラゴンクエストXI 過ぎ去りし時を求めて S（Switch）", category: "ゲーム", emoji: "🕹️",
  ...
  {
    id: "G049", name: "ドラゴンクエストIII そして伝説へ…（Switch）", category: "ゲーム", emoji: "🎲",
  ...
  {
    id: "G050", name: "ドラゴンクエストI＆II（Switch）", category: "ゲーム", emoji: "🐲",
  ...
  {
    id: "G051", name: "ドラゴンクエストビルダーズ2 破壊神シドーとからっぽの島（Switch）", category: "ゲーム", emoji: "🧱",
  ...
  /* ============================== 音楽 ============================== */
  {
    id: "G009", name: "ドラゴンクエストVII エデンの戦士たち オリジナルサウンドトラック", category: "音楽", emoji: "🎵",
  ...
  {
    id: "G052", name: "ドラゴンクエストVIII 空と海と大地と呪われし姫君 サウンドトラック", category: "音楽", emoji: "🎼",
  ...
  {
    id: "G053", name: "ドラゴンクエストIX 星空の守り人 シンセ版＆オリジナル版", category: "音楽", emoji: "🌌",
  ...
  {
    id: "G054", name: "ニンテンドー3DS ドラゴンクエストVIII オリジナルサウンドトラック", category: "音楽", emoji: "🎧",
